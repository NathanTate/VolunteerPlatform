        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOrganizationApproved = table.Column<bool>(type: "bit", nullable: false),
                    IsVolunteerConfirmed = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RadiusKm = table.Column<double>(type: "float", nullable: false, defaultValue: 5.0),
                    RequiredVolunteers = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationRequests_Initiatives_InitiativeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InitiativeImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InitiativeImages_Initiatives_InitiativeId",
                        column: x => x.InitiativeId,
                        principalTable: "Initiatives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletionProofUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_AspNetUsers_AssignedVolunteerId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_Initiatives_InitiativeId",
                        column: x => x.InitiativeId,
                        principalTable: "Initiatives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRequests_InitiativeId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InitiativeImages_InitiativeId",
                table: "InitiativeImages",
                column: "InitiativeId");

            migrationBuilder.CreateIndex(
                name: "IX_Initiatives_Category",
                table: "Initiatives",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_Initiatives_IsEmergency",
                table: "Initiatives",
                column: "IsEmergency");

            migrationBuilder.CreateIndex(
                name: "IX_Initiatives_Latitude_Longitude",
                table: "Initiatives",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Initiatives_UrgencyLevel",
                table: "Initiatives",
                column: "UrgencyLevel");
